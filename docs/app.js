...
var JoinTeamModal = function JoinTeamModal(_ref44) {
  ...
  var search = function () {
    var _ref45 = _asyncToGenerator(_regenerator().m(function _callee17(c) {
      var q, t, _t24;
  ...
  var accept = function () {
    var _ref46 = _asyncToGenerator(_regenerator().m(function _callee18() {
...
var HomeTab = function HomeTab(_ref48) {
  ...
  return React.createElement("div", {
    ...
    }, podiumItems.map(function (_ref51) {
      var m = _ref51.m,
        place = _ref51.place,
        medal = _ref51.medal,
        h = _ref51.h,
...
var FinesTab = function FinesTab(_ref52) {
  var team = _ref52.team,
    fines = _ref52.fines,
    members = _ref52.members,
    isAdmin = _ref52.isAdmin,
    onAddFine = _ref52.onAddFine,
    onTogglePaid = _ref52.onTogglePaid,
    onSelectMember = _ref52.onSelectMember;
...
var EventCard = function EventCard(_ref55) {
  var t = _ref55.t,
    ...
    ctxMenu = _ref55.ctxMenu,
    setCtxMenu = _ref55.setCtxMenu,
    onDelete = _ref55.onDelete,
    setEditTarget = _ref55.setEditTarget,
...
var TreinosPage = function TreinosPage(_ref58) {
  var team = _ref58.team,
    ...
    onAddType = _ref58.onAddType,
    onDelete = _ref58.onDelete,
    onEdit = _ref58.onEdit,
    onBack = _ref58.onBack,
    modal = _ref58.modal,
    setModal = _ref58.setModal;
  ...
  return React.createElement("div", {
  ...
  })), Object.entries(byMonth).map(function (_ref59) {
  ...
  }, "Tipo de evento"), [[null, "📅 Todos"], ["recorrente", "🔄 Recorrente"], ["treino", "📅 Treino único"], ["jogo", "⚽ Jogo"]].map(function (_ref61) {
    ...
    team: team,
    onAdd: (function () {
      var _ref63 = _asyncToGenerator(_regenerator().m(function _callee19(t) {
...
var TreasuryTab = function TreasuryTab(_ref66) {
  var team = _ref66.team,
    fines = _ref66.fines,
    members = _ref66.members,
    expenses = _ref66.expenses,
    isAdmin = _ref66.isAdmin,
    onAddExpense = _ref66.onAddExpense;
  var tf = fines.filter(function (f) {
...
var AppAdminTab = function AppAdminTab(_ref67) {
  var token = _ref67.token;
  var _useState153 = useState(null),
    _useState154 = _slicedToArray(_useState153, 2),
    stats = _useState154[0],
    setStats = _useState154[1];
  var _useState155 = useState([]),
    _useState156 = _slicedToArray(_useState155, 2),
    users = _useState156[0],
    setUsers = _useState156[1];
  var _useState157 = useState([]),
    _useState158 = _slicedToArray(_useState157, 2),
    teams = _useState158[0],
    setTeams = _useState158[1];
  var _useState159 = useState("stats"),
    _useState160 = _slicedToArray(_useState159, 2),
    section = _useState160[0],
    setSection = _useState160[1];
  var _useState161 = useState(null),
    _useState162 = _slicedToArray(_useState161, 2),
    selectedTeam = _useState162[0],
    setSelectedTeam = _useState162[1];
  var _useState163 = useState(null),
    _useState164 = _slicedToArray(_useState163, 2),
    teamDetail = _useState164[0],
    setTeamDetail = _useState164[1];
  var _useState165 = useState(false),
    _useState166 = _slicedToArray(_useState165, 2),
    detailLoading = _useState166[0],
    setDetailLoading = _useState166[1];
  var _useState167 = useState(true),
    _useState168 = _slicedToArray(_useState167, 2),
    loading = _useState168[0],
    setLoading = _useState168[1];
  useEffect(function () {
    var load = function () {
      var _ref68 = _asyncToGenerator(_regenerator().m(function _callee22() {
        var rpc, _yield$Promise$all, _yield$Promise$all2, sr, ur, tr, _t25, _t26, _t27, _t28, _t29, _t30;
  ...
  var _useState169 = useState(null),
    ...
    detailError = _useState170[0],
    setDetailError = _useState170[1];
  var openTeam = function () {
    var _ref69 = _asyncToGenerator(_regenerator().m(function _callee23(team) {
      var r, data, _t31;
  ...
  return React.createElement("div", {
    ...
    }, [["👥", t.members_count, "membros"], ["🟥", t.fines_count, "multas"], ["💸", "".concat(t.unpaid_total, "\u20AC"), "por pagar"], ["📅", t.trainings_count, "treinos"]].map(function (_ref73) {
...
var GeneralTab = function GeneralTab(_ref75) {
  var user = _ref75.user,
    myUserId = _ref75.myUserId,
    teams = _ref75.teams,
    members = _ref75.members,
    onEditProfile = _ref75.onEditProfile,
    onManageTeam = _ref75.onManageTeam,
    onCreateTeam = _ref75.onCreateTeam,
    onJoinTeam = _ref75.onJoinTeam,
    onLogout = _ref75.onLogout;
  ...
  }, [["🏃 Posição", user.position || "—", false], ["📱 Telefone", user.phone || "—", false], ["🎂 Aniversário", user.birthday ? "".concat(fmtDate(user.birthday)).concat(myAge ? " \xB7 ".concat(myAge, " anos") : "") : "—", true]].map(function (_ref76) {
...
var EmojiPicker = function EmojiPicker(_ref78) {
...
var FineTypesManager = function FineTypesManager(_ref79) {
  var team = _ref79.team,
    fineTypes = _ref79.fineTypes,
    onAdded = _ref79.onAdded,
    onDeleted = _ref79.onDeleted,
    onUpdated = _ref79.onUpdated,
    token = _ref79.token;
  var _useState171 = useState(false),
    _useState172 = _slicedToArray(_useState171, 2),
    adding = _useState172[0],
    setAdding = _useState172[1];
  var _useState173 = useState(null),
    _useState174 = _slicedToArray(_useState173, 2),
    editingId = _useState174[0],
    setEditingId = _useState174[1];
  var _useState175 = useState(""),
    _useState176 = _slicedToArray(_useState175, 2),
    name = _useState176[0],
    setName = _useState176[1];
  ...
  var _useState179 = useState("🟥"),
    ...
    emoji = _useState180[0],
    setEmoji = _useState180[1];
  var _useState181 = useState("🟥"),
    _useState182 = _slicedToArray(_useState181, 2),
    editEmoji = _useState182[0],
    setEditEmoji = _useState182[1];
  var _useState183 = useState(""),
    _useState184 = _slicedToArray(_useState183, 2),
    err = _useState184[0],
    setErr = _useState184[1];
  var _useState185 = useState(false),
    _useState186 = _slicedToArray(_useState185, 2),
    saving = _useState186[0],
    setSaving = _useState186[1];
  var tf = fineTypes.filter(function (f) {
    return f.teamId === team.id;
  });
  var save = function () {
    var _ref80 = _asyncToGenerator(_regenerator().m(function _callee24() {
      var res, ft, _t32;
  ...
  var saveEmoji = function () {
    var _ref81 = _asyncToGenerator(_regenerator().m(function _callee25(id) {
      var _t33;
...
var ManageTeamScreen = function ManageTeamScreen(_ref83) {
  var team = _ref83.team,
    members = _ref83.members,
    fineTypes = _ref83.fineTypes,
    token = _ref83.token,
    myUserId = _ref83.myUserId,
    onBack = _ref83.onBack,
    onAddMember = _ref83.onAddMember,
    onToggleRole = _ref83.onToggleRole,
    onRemoveMember = _ref83.onRemoveMember,
    onEditMember = _ref83.onEditMember,
    onRegenerateCode = _ref83.onRegenerateCode,
    onDeleteTeam = _ref83.onDeleteTeam,
    setFineTypes = _ref83.setFineTypes;
  var tm = members.filter(function (m) {
    return m.teamId === team.id;
  });
  ...
  var _useState187 = useState(null),
    ...
    confirmRemove = _useState188[0],
    setConfirmRemove = _useState188[1];
  var _useState189 = useState(null),
    _useState190 = _slicedToArray(_useState189, 2),
    editingMember = _useState190[0],
    setEditingMember = _useState190[1];
  var _useState191 = useState(false),
    _useState192 = _slicedToArray(_useState191, 2),
    copied = _useState192[0],
    setCopied = _useState192[1];
...
var MemberDetailScreen = function MemberDetailScreen(_ref85) {
  var member = _ref85.member,
    team = _ref85.team,
    fines = _ref85.fines,
    onBack = _ref85.onBack,
    onTogglePaid = _ref85.onTogglePaid,
    isAdmin = _ref85.isAdmin;
...
var LoginScreen = function LoginScreen(_ref86) {
  var onLogin = _ref86.onLogin;
  var _useState193 = useState("patricio@multeam.app"),
    _useState194 = _slicedToArray(_useState193, 2),
    email = _useState194[0],
    setEmail = _useState194[1];
  var _useState195 = useState("••••••••"),
    _useState196 = _slicedToArray(_useState195, 2),
    pass = _useState196[0],
    setPass = _useState196[1];
  var inp = {
    width: "100%",
    padding: "14px 16px",
    borderRadius: 14,
...
var ResetPasswordScreen = function ResetPasswordScreen(_ref87) {
  var accessToken = _ref87.accessToken,
    onDone = _ref87.onDone;
  var _useState197 = useState(""),
    _useState198 = _slicedToArray(_useState197, 2),
    pass = _useState198[0],
    setPass = _useState198[1];
  var _useState199 = useState(""),
    _useState200 = _slicedToArray(_useState199, 2),
    pass2 = _useState200[0],
    setPass2 = _useState200[1];
  var _useState201 = useState(false),
    _useState202 = _slicedToArray(_useState201, 2),
    showPass = _useState202[0],
    setShowPass = _useState202[1];
  ...
  var save = function () {
    var _ref88 = _asyncToGenerator(_regenerator().m(function _callee27() {
      var _t35;
      return _regenerator().w(function (_context27) {
        while (1) switch (_context27.p = _context27.n) {
          case 0:
            ...
            return _context27.a(2, setErr("Mínimo 6 caracteres"));
          case 1:
            if (!(pass !== pass2)) {
              _context27.n = 2;
              break;
            }
            return _context27.a(2, setErr("As passwords não coincidem"));
          case 2:
            setLoading(true);
            setErr("");
            _context27.p = 3;
...
var AuthScreen = function AuthScreen(_ref89) {
  var onLogin = _ref89.onLogin,
    onRegister = _ref89.onRegister,
    error = _ref89.error,
    loading = _ref89.loading;
  var _useState209 = useState("login"),
    _useState210 = _slicedToArray(_useState209, 2),
    mode = _useState210[0],
    setMode = _useState210[1];
  var _useState211 = useState(""),
    _useState212 = _slicedToArray(_useState211, 2),
    email = _useState212[0],
    setEmail = _useState212[1];
  var _useState213 = useState(""),
    _useState214 = _slicedToArray(_useState213, 2),
    pass = _useState214[0],
    setPass = _useState214[1];
  var _useState215 = useState(""),
    _useState216 = _slicedToArray(_useState215, 2),
    name = _useState216[0],
    setName = _useState216[1];
  var _useState217 = useState(false),
    _useState218 = _slicedToArray(_useState217, 2),
    showPass = _useState218[0],
    setShowPass = _useState218[1];
  var inp = {
    width: "100%",
    padding: "14px 16px",
    borderRadius: 14,
  ...
  return React.createElement("div", {
  ...
  }, [["login", "Entrar"], ["register", "Criar conta"]].map(function (_ref90) {
    ...
    onClick: _asyncToGenerator(_regenerator().m(function _callee28() {
...
var Spinner = function Spinner(_ref94) {
  var _ref94$msg = _ref94.msg,
    msg = _ref94$msg === void 0 ? "A carregar..." : _ref94$msg;
  return React.createElement("div", {
    style: {
      minHeight: "100vh",
      display: "flex",
...
function App() {
  var _useState219 = useState(function () {
    ...
    _useState220 = _slicedToArray(_useState219, 1),
    recoveryToken = _useState220[0];
  ...
  var loadTeam = function () {
    var _ref95 = _asyncToGenerator(_regenerator().m(function _callee30(tok, tid) {
      ...
      return _regenerator().w(function (_context30) {
        while (1) switch (_context30.n) {
          ...
          case 1:
            _yield$Promise$all3 = _context30.v;
  ...
  var initApp = function () {
    var _ref96 = _asyncToGenerator(_regenerator().m(function _callee31(tok, uid) {
      var profData, p, created, myTeamsR, adapted, teamsJson, teamsList, first, td, _t36, _t37;
      return _regenerator().w(function (_context31) {
        while (1) switch (_context31.p = _context31.n) {
          ...
          case 5:
            _context31.p = 5;
            _t36 = _context31.v;
            console.warn('Profile creation fallback failed:', _t36);
          case 6:
            if (p) setProfile({
              id: p.id,
              name: p.name || '',
          ...
          case 12:
            _context31.p = 12;
            _t37 = _context31.v;
            setAuthError("Erro: ".concat(_t37.message));
          case 13:
            _context31.p = 13;
            setLoading(false);
            return _context31.f(13);
          case 14:
            return _context31.a(2);
        }
      }, _callee31, null, [[3, 5], [1, 12, 13, 14]]);
    }));
  ...
  var switchTeam = function () {
    var _ref97 = _asyncToGenerator(_regenerator().m(function _callee32(id) {
      var td, _t38;
  ...
  var refresh = useCallback(_asyncToGenerator(_regenerator().m(function _callee33() {
    var td, _t39;
  ...
  var handleLogin = function () {
    var _ref99 = _asyncToGenerator(_regenerator().m(function _callee34(email, pass) {
      var _d$session, _d$user, d, tok, uid, _t40;
  ...
  var handleRegister = function () {
    var _ref100 = _asyncToGenerator(_regenerator().m(function _callee35(email, pass, name) {
      var _d$session2, _d$user2, d, tok, uid, _d2$session, d2, tok2, _t41, _t42, _t43;
  ...
  var addFine = function () {
    var _ref101 = _asyncToGenerator(_regenerator().m(function _callee36(d) {
  ...
  var togglePaid = function () {
    var _ref102 = _asyncToGenerator(_regenerator().m(function _callee37(id) {
      var f, _t44;
  ...
  var addExpense = function () {
    var _ref103 = _asyncToGenerator(_regenerator().m(function _callee38(d) {
      var _yield$api$post3, _yield$api$post4, e, _t45;
  ...
  var editTraining = function () {
    var _ref106 = _asyncToGenerator(_regenerator().m(function _callee41(id, d) {
      var patch, res, t;
  ...
  var setPresence = function () {
    var _ref107 = _asyncToGenerator(_regenerator().m(function _callee42(tid, mid, status) {
      var _t47;
  ...
  var editMember = function () {
    var _ref111 = _asyncToGenerator(_regenerator().m(function _callee46(id, data) {
      var m, _t51;
  ...
  var _useState261 = useState(null),
    ...
    teamError = _useState262[0],
    setTeamError = _useState262[1];
  var createTeam = function () {
    var _ref112 = _asyncToGenerator(_regenerator().m(function _callee47(d) {
      var tid, invCode, sr, se, tr, newTeam, _t52;
      return _regenerator().w(function (_context47) {
        while (1) switch (_context47.p = _context47.n) {
          ...
          case 8:
            _context47.p = 8;
            _t52 = _context47.v;
            setTeamError(_t52.message || JSON.stringify(_t52));
          case 9:
  ...
  var deleteTeam = function () {
    var _ref113 = _asyncToGenerator(_regenerator().m(function _callee48(teamId) {
      var remaining, _t53;
      return _regenerator().w(function (_context48) {
        while (1) switch (_context48.p = _context48.n) {
          ...
          case 5:
            _context48.p = 5;
            _t53 = _context48.v;
            console.error('deleteTeam error:', _t53);
          case 6:
  ...
  var joinTeam = function () {
    var _ref114 = _asyncToGenerator(_regenerator().m(function _callee49(t) {
      var _yield$api$get, _yield$api$get2, td, _t54;
  ...
  var findTeamByCode = function () {
    var _ref115 = _asyncToGenerator(_regenerator().m(function _callee50(code) {
      var r, d, t, _t55;
      return _regenerator().w(function (_context50) {
        while (1) switch (_context50.p = _context50.n) {
          ...
          case 2:
            ...
            return _context50.a(2, t !== null && t !== void 0 && t.id ? aTeam(_objectSpread(_objectSpread({}, t), {}, {
              invite_code: t.invite_code
            })) : null);
          case 3:
            _context50.p = 3;
            _t55 = _context50.v;
            return _context50.a(2, null);
        }
      }, _callee50, null, [[0, 3]]);
    }));
  ...
  var _useState263 = useState(function () {
    ...
    pendingInvite = _useState264[0],
    setPendingInvite = _useState264[1];
  useEffect(function () {
  ...
  var subscribeToPush = function () {
    var _ref116 = _asyncToGenerator(_regenerator().m(function _callee51(tok, uid) {
      var _subJson$keys, _subJson$keys2, reg, existing, _sub, subJson, _t56, _t57;
      return _regenerator().w(function (_context51) {
        while (1) switch (_context51.p = _context51.n) {
          ...
          case 7:
            _context51.p = 7;
            _t57 = _context51.v;
            console.warn("Push subscribe failed:", _t57.message);
          case 8:
            return _context51.a(2);
        }
      }, _callee51, null, [[1, 7]]);
  ...
  useEffect(function () {
    ...
    if ("Notification" in window && Notification.permission === "default") {
      setTimeout(_asyncToGenerator(_regenerator().m(function _callee52() {
        var perm;
  ...
  var _useState265 = useState(null),
    ...
    toast = _useState266[0],
    setToast = _useState266[1];
  ...
  var sendPushToTeam = function () {
    var _ref118 = _asyncToGenerator(_regenerator().m(function _callee53(teamId, members, title, body) {
      var userIds, _t58;
      return _regenerator().w(function (_context53) {
        while (1) switch (_context53.p = _context53.n) {
          ...
          case 3:
            _context53.p = 3;
            _t58 = _context53.v;
            console.warn("Push send failed:", _t58.message);
          case 4:
            return _context53.a(2);
        }
      }, _callee53, null, [[1, 3]]);
  ...
  var addFineWithToast = function () {
    var _ref119 = _asyncToGenerator(_regenerator().m(function _callee54(d) {
      var m;
  ...
  if (!team) return React.createElement("div", {
    ...
    onJoin: (function () {
      var _ref120 = _asyncToGenerator(_regenerator().m(function _callee55(t) {
  ...
  return React.createElement("div", {
    ...
    user: profile || {},
    onSave: (function () {
      var _ref121 = _asyncToGenerator(_regenerator().m(function _callee56(u) {
        var _members$find;
    ...
    onFindByCode: findTeamByCode,
    onJoin: (function () {
      var _ref122 = _asyncToGenerator(_regenerator().m(function _callee57(t) {
