...
var RoleBadgeLight = function RoleBadgeLight(_ref7) {
  ...
  var c = cfg[role] || cfg.player;
  return React.createElement("div", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      gap: 4,
      background: "".concat(c.color, "12"),
      border: "1px solid ".concat(c.color, "30"),
      borderRadius: 6,
      padding: "3px 8px"
    }
  }, React.createElement("span", {
  ...
  useEffect(function () {
    ...
    Promise.all([fetch("".concat(SB_URL, "/rest/v1/team_members?team_id=eq.").concat(team.id, "&select=*"), {
      ...
      var _ref16 = _asyncToGenerator(_regenerator().m(function _callee11(_ref15) {
        var _ref17, mRaw, ftRaw, uids, profMap, rpcRes, pr, _t19;
          ...
          while (1) switch (_context11.p = _context11.n) {
            case 0:
              ...
              return fetch("".concat(SB_URL, "/rest/v1/rpc/get_team_profiles"), {
                method: 'POST',
                headers: _objectSpread(_objectSpread({}, H), {}, {
                  'Content-Type': 'application/json'
                }),
                body: JSON.stringify({
                  p_team_id: team.id
            ...
            case 2:
              rpcRes = _context11.v;
              (Array.isArray(rpcRes) ? rpcRes : []).forEach(function (p) {
                profMap[p.id] = p;
              });
              _context11.n = 4;
              break;
            ...
            case 6:
              setTm((Array.isArray(mRaw) ? mRaw : []).map(function (m) {
                var _profMap$m$user_id, _profMap$m$user_id2, _profMap$m$user_id3, _profMap$m$user_id4, _profMap$m$user_id5, _profMap$m$user_id6;
                return {
                  id: String(m.id),
                  teamId: m.team_id,
                  userId: m.user_id,
                  ...
                  phone: ((_profMap$m$user_id2 = profMap[m.user_id]) === null || _profMap$m$user_id2 === void 0 ? void 0 : _profMap$m$user_id2.phone) || '',
                  birthday: ((_profMap$m$user_id3 = profMap[m.user_id]) === null || _profMap$m$user_id3 === void 0 ? void 0 : _profMap$m$user_id3.birthday) || '',
                  position: m.position || ((_profMap$m$user_id4 = profMap[m.user_id]) === null || _profMap$m$user_id4 === void 0 ? void 0 : _profMap$m$user_id4.position) || 'Jogador',
                  avatarUrl: ((_profMap$m$user_id5 = profMap[m.user_id]) === null || _profMap$m$user_id5 === void 0 ? void 0 : _profMap$m$user_id5.avatar_url) || null,
                  initials: (((_profMap$m$user_id6 = profMap[m.user_id]) === null || _profMap$m$user_id6 === void 0 ? void 0 : _profMap$m$user_id6.name) || 'U').split(' ').map(function (w) {
                    return w[0];
                  }).join('').slice(0, 2).toUpperCase()
                };
              }));
...
var TabelaMultasModal = function TabelaMultasModal(_ref57) {
  var team = _ref57.team,
    fineTypes = _ref57.fineTypes,
    fines = _ref57.fines,
  ...
  var _React$useState7 = React.useState("tipos"),
  ...
  return React.createElement(Sheet, {
    title: "\uD83D\uDCCB Tabela de Multas \u2014 ".concat(team.name),
    onClose: onClose
  }, React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, "Tipos"), React.createElement(Chip, {
    active: tab === "devedores",
    color: T.brand,
    onClick: function onClick() {
      return setTab("devedores");
    }
  }, "Por pagar (", devedores.length, ")")), tab === "tipos" && React.createElement(React.Fragment, null, tf.length === 0 && React.createElement("p", {
    style: {
      color: T.sub,
      textAlign: "center",
      padding: 20
    }
  }, "Sem tipos de multa definidos"), tf.sort(function (a, b) {
  ...
  })), tab === "devedores" && React.createElement(React.Fragment, null, devedores.length === 0 && React.createElement("p", {
    style: {
      color: T.green,
      textAlign: "center",
      padding: 20,
  ...
  }, "\u2713 Toda a equipa est\xE1 em dia!"), devedores.map(function (m, i) {
    return React.createElement("div", {
      key: m.id,
      style: {
        background: i === 0 ? "linear-gradient(135deg,".concat(T.brand, ",#c0392b)") : T.card,
        borderRadius: 12,
        padding: "12px 14px",
        marginBottom: 8,
        display: "flex",
        alignItems: "center",
        gap: 12,
        border: i === 0 ? "none" : "1px solid ".concat(T.border)
      }
      ...
      style: {
        ...
        height: 40,
        borderRadius: 20,
        background: i === 0 ? "rgba(255,255,255,0.25)" : team.color,
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        color: "#fff",
      ...
      style: {
        margin: 0,
        fontSize: 12,
        color: i === 0 ? "rgba(255,255,255,0.7)" : T.sub
      }
    }, m.count, " multa", m.count !== 1 ? "s" : "", " por pagar")), React.createElement("p", {
      style: {
        margin: 0,
        fontWeight: 900,
        fontSize: 20,
...
var HomeTab = function HomeTab(_ref58) {
  var team = _ref58.team,
    fines = _ref58.fines,
    members = _ref58.members,
    expenses = _ref58.expenses,
    trainings = _ref58.trainings,
    isAdmin = _ref58.isAdmin,
    onAddFine = _ref58.onAddFine,
    onSelectMember = _ref58.onSelectMember,
    fineTypes = _ref58.fineTypes;
  var tf = fines.filter(function (f) {
    return f.teamId === team.id;
  });
  var _React$useState9 = React.useState(false),
    _React$useState0 = _slicedToArray(_React$useState9, 2),
    showTabela = _React$useState0[0],
    setShowTabela = _React$useState0[1];
  ...
  return React.createElement("div", {
  ...
  }, [["Recebido", "+".concat(collected, "\u20AC"), "#fff"], ["Por pagar", "".concat(pending, "\u20AC"), "#FFD6D6"], ["Despesas", "-".concat(spent, "\u20AC"), "rgba(255,255,255,0.65)"]].map(function (_ref59, i, arr) {
  ...
  }, "\uD83D\uDFE5 Atribuir multa"), React.createElement("button", {
    onClick: function onClick() {
      return setShowTabela(true);
    },
    style: {
      width: "100%",
      background: T.card,
  ...
  }, "\uD83D\uDCCB Tabela de multas & devedores"), showTabela && React.createElement(TabelaMultasModal, {
    team: team,
    fineTypes: fineTypes || [],
    fines: fines,
    members: members,
    onClose: function onClose() {
      return setShowTabela(false);
    }
  }), function () {
    var now = new Date();
    ...
    var _React$useState1 = React.useState(false),
      ...
      showAll = _React$useState10[0],
      setShowAll = _React$useState10[1];
    ...
    }, podiumItems.map(function (_ref61) {
      var m = _ref61.m,
        place = _ref61.place,
        medal = _ref61.medal,
        h = _ref61.h,
...
var FinesTab = function FinesTab(_ref62) {
  var team = _ref62.team,
    fines = _ref62.fines,
    members = _ref62.members,
    isAdmin = _ref62.isAdmin,
    onAddFine = _ref62.onAddFine,
    onTogglePaid = _ref62.onTogglePaid,
    onDeleteFine = _ref62.onDeleteFine,
    onEditFine = _ref62.onEditFine,
    onSelectMember = _ref62.onSelectMember;
  ...
  var FineCard = function FineCard(_ref63) {
    var f = _ref63.f;
    var m = gm(f.memberId);
    return React.createElement("div", {
      style: {
  ...
  if (filter === "month") {
    ...
    }, "\uD83D\uDCC5 Por m\xEAs")), Object.entries(byMonth).map(function (_ref64) {
...
var PresCounter = function PresCounter(_ref66) {
...
var PresBar = function PresBar(_ref67) {
  var t = _ref67.t,
...
var EventCard = function EventCard(_ref68) {
  var t = _ref68.t,
    team = _ref68.team,
    members = _ref68.members,
    isAdmin = _ref68.isAdmin,
    ctxMenu = _ref68.ctxMenu,
    setCtxMenu = _ref68.setCtxMenu,
    onDelete = _ref68.onDelete,
    setEditTarget = _ref68.setEditTarget,
    myMember = _ref68.myMember,
    presences = _ref68.presences,
    onSetPresence = _ref68.onSetPresence;
...
var TreinosPage = function TreinosPage(_ref71) {
  var team = _ref71.team,
    trainings = _ref71.trainings,
    members = _ref71.members,
    myUserId = _ref71.myUserId,
    isAdmin = _ref71.isAdmin,
    presences = _ref71.presences,
    onSetPresence = _ref71.onSetPresence,
    onAddType = _ref71.onAddType,
    onDelete = _ref71.onDelete,
    onEdit = _ref71.onEdit,
    onLogSession = _ref71.onLogSession,
    onBack = _ref71.onBack,
    modal = _ref71.modal,
    setModal = _ref71.setModal;
  ...
  return React.createElement("div", {
  ...
  })), Object.entries(byMonth).map(function (_ref72) {
  ...
  }, "Tipo de evento"), [[null, "📅 Todos"], ["recorrente", "🔄 Recorrente"], ["treino", "📅 Treino único"], ["jogo", "⚽ Jogo"]].map(function (_ref74) {
    ...
    team: team,
    onAdd: (function () {
      var _ref76 = _asyncToGenerator(_regenerator().m(function _callee23(t) {
    ...
    team: team,
    onAdd: (function () {
      var _ref77 = _asyncToGenerator(_regenerator().m(function _callee24(t) {
    ...
    members: members,
    onAdd: (function () {
      var _ref78 = _asyncToGenerator(_regenerator().m(function _callee25(t) {
...
var TreasuryTab = function TreasuryTab(_ref79) {
  var team = _ref79.team,
    fines = _ref79.fines,
    members = _ref79.members,
    expenses = _ref79.expenses,
    isAdmin = _ref79.isAdmin,
    onAddExpense = _ref79.onAddExpense;
  var tf = fines.filter(function (f) {
...
var AppAdminTab = function AppAdminTab(_ref80) {
  ...
  useEffect(function () {
    var load = function () {
      var _ref81 = _asyncToGenerator(_regenerator().m(function _callee26() {
        var rpc, _yield$Promise$all, _yield$Promise$all2, sr, ur, tr, _t29, _t30, _t31, _t32, _t33, _t34;
  ...
  var openTeam = function () {
    var _ref82 = _asyncToGenerator(_regenerator().m(function _callee27(team) {
      var r, data, _t35;
  ...
  var StatCard = function StatCard(_ref83) {
    var label = _ref83.label,
      value = _ref83.value,
      color = _ref83.color;
    return React.createElement("div", {
      style: {
  ...
  return React.createElement("div", {
    ...
    }, [["👥", t.members_count, "membros"], ["🟥", t.fines_count, "multas"], ["💸", "".concat(t.unpaid_total, "\u20AC"), "por pagar"], ["📅", t.trainings_count, "treinos"]].map(function (_ref86) {
...
var GeneralTab = function GeneralTab(_ref88) {
  var user = _ref88.user,
    myUserId = _ref88.myUserId,
    teams = _ref88.teams,
    members = _ref88.members,
    onEditProfile = _ref88.onEditProfile,
    onManageTeam = _ref88.onManageTeam,
    onCreateTeam = _ref88.onCreateTeam,
    onJoinTeam = _ref88.onJoinTeam,
    onLeaveTeam = _ref88.onLeaveTeam,
    onLogout = _ref88.onLogout,
    onAdminOpen = _ref88.onAdminOpen,
    isAppAdmin = _ref88.isAppAdmin,
    token = _ref88.token;
  ...
  var openTeamMembers = function () {
    var _ref89 = _asyncToGenerator(_regenerator().m(function _callee28(teamId) {
      var mRaw, uids, profilesMap, profs, merged, _t36;
  ...
  return React.createElement("div", {
  ...
  }, [["🏃 Posição", user.position || "—", false], ["📱 Telefone", user.phone || "—", false], ["🎂 Aniversário", user.birthday ? "".concat(fmtDate(user.birthday)).concat(myAge ? " \xB7 ".concat(myAge, " anos") : "") : "—", true]].map(function (_ref90) {
    ...
    }, "\uD83D\uDC65 Ver membros da equipa"), !admin && React.createElement("button", {
      onClick: function onClick() {
        if (window.confirm("Sair de \"".concat(t.name, "\"? Perdes o acesso \xE0 equipa."))) onLeaveTeam(t.id);
      },
      style: {
        width: "100%",
        marginTop: 6,
        background: "transparent",
        border: "1px solid ".concat(T.brand),
        borderRadius: 10,
        padding: "8px",
        fontSize: 12,
        fontWeight: 700,
...
var EmojiPicker = function EmojiPicker(_ref92) {
  var value = _ref92.value,
    onChange = _ref92.onChange,
    color = _ref92.color;
  return React.createElement("div", {
    style: {
      marginBottom: 12
...
var FineTypesManager = function FineTypesManager(_ref93) {
  var team = _ref93.team,
    fineTypes = _ref93.fineTypes,
    onAdded = _ref93.onAdded,
    onDeleted = _ref93.onDeleted,
    onUpdated = _ref93.onUpdated,
    token = _ref93.token;
  ...
  var save = function () {
    var _ref94 = _asyncToGenerator(_regenerator().m(function _callee29() {
      var res, ft, _t37;
  ...
  var saveEdit = function () {
    var _ref95 = _asyncToGenerator(_regenerator().m(function _callee30(id) {
      var _t38;
  ...
  var del = function () {
    var _ref96 = _asyncToGenerator(_regenerator().m(function _callee31(id) {
      var _t39;
...
var ManageTeamScreen = function ManageTeamScreen(_ref97) {
  var team = _ref97.team,
    members = _ref97.members,
    fineTypes = _ref97.fineTypes,
    token = _ref97.token,
    myUserId = _ref97.myUserId,
    onBack = _ref97.onBack,
    onAddMember = _ref97.onAddMember,
    onToggleRole = _ref97.onToggleRole,
    onRemoveMember = _ref97.onRemoveMember,
    onEditMember = _ref97.onEditMember,
    onRegenerateCode = _ref97.onRegenerateCode,
    onDeleteTeam = _ref97.onDeleteTeam,
    setFineTypes = _ref97.setFineTypes;
  var tm = members.filter(function (m) {
    return m.teamId === team.id;
  });
  ...
  var Row = function Row(_ref98) {
    ...
    return React.createElement("div", {
    ...
    }, "\u270F\uFE0F Editar"), m.userId !== myUserId && React.createElement(React.Fragment, null, React.createElement("div", {
      style: {
        display: "flex",
        gap: 4,
        flexWrap: "wrap"
      }
    }, [["admin", "🛡 Admin", "#1D3557"], ["treinador", "🎽 Treinador", "#2E7D32"], ["diretor", "📋 Diretor", "#7B1FA2"], ["player", "👤 Jogador", "#86868B"]].map(function (_ref99) {
      ...
      return React.createElement("button", {
        key: r,
        onClick: function onClick() {
          return m.role !== r && onToggleRole(m.id, r);
        },
        style: {
          padding: "7px 10px",
          borderRadius: 10,
          border: "1.5px solid ".concat(m.role === r ? c : T.border),
          background: m.role === r ? "".concat(c, "15") : "transparent",
          color: m.role === r ? c : T.sub,
          fontSize: 12,
          fontWeight: 700,
...
var MemberDetailScreen = function MemberDetailScreen(_ref101) {
  var member = _ref101.member,
    team = _ref101.team,
    fines = _ref101.fines,
    onBack = _ref101.onBack,
    onTogglePaid = _ref101.onTogglePaid,
    onDeleteFine = _ref101.onDeleteFine,
    isAdmin = _ref101.isAdmin;
...
var LoginScreen = function LoginScreen(_ref102) {
...
var ResetPasswordScreen = function ResetPasswordScreen(_ref103) {
  var accessToken = _ref103.accessToken,
  ...
  var save = function () {
    var _ref104 = _asyncToGenerator(_regenerator().m(function _callee32() {
      var _t40;
...
var AuthScreen = function AuthScreen(_ref105) {
  var onLogin = _ref105.onLogin,
    onRegister = _ref105.onRegister,
    error = _ref105.error,
    loading = _ref105.loading;
  ...
  }, [["login", "Entrar"], ["register", "Criar conta"]].map(function (_ref106) {
...
var Spinner = function Spinner(_ref110) {
  var _ref110$msg = _ref110.msg,
    msg = _ref110$msg === void 0 ? "A carregar..." : _ref110$msg;
  return React.createElement("div", {
    style: {
      minHeight: "100vh",
      display: "flex",
...
function App() {
  var _members$find, _members$find2;
  ...
  var myRole = ((_members$find = members.find(function (m) {
    return m.teamId === teamId && m.userId === myUserId;
  })) === null || _members$find === void 0 ? void 0 : _members$find.role) || "player";
  var canManageTrainings = isAdmin || myRole === "treinador" || myRole === "diretor";
  var loadTeam = function () {
    var _ref111 = _asyncToGenerator(_regenerator().m(function _callee35(tok, tid) {
      var _yield$Promise$all3, _yield$Promise$all4, mRaw, ftData, fData, eData, tData, pData, profilesMap, profs, uids, _profs, mData, presMap, _t41, _t42;
      return _regenerator().w(function (_context35) {
        while (1) switch (_context35.p = _context35.n) {
          ...
          case 4:
            _context35.p = 4;
            _t41 = _context35.v;
            console.warn('get_team_profiles failed:', _t41);
          case 5:
  ...
  var initApp = function () {
    var _ref112 = _asyncToGenerator(_regenerator().m(function _callee36(tok, uid) {
      var profData, p, created, membershipsR, adapted, memberships, teamIds, teamsR, teamsJson, first, td, _t43, _t44;
      return _regenerator().w(function (_context36) {
        while (1) switch (_context36.p = _context36.n) {
          ...
          case 5:
            _context36.p = 5;
            _t43 = _context36.v;
            console.warn('Profile creation fallback failed:', _t43);
          case 6:
            if (p) setProfile({
              id: p.id,
              name: p.name || '',
          ...
          case 14:
            _context36.p = 14;
            _t44 = _context36.v;
            setAuthError("Erro: ".concat(_t44.message));
          case 15:
            _context36.p = 15;
            setLoading(false);
  ...
  var switchTeam = function () {
    var _ref113 = _asyncToGenerator(_regenerator().m(function _callee37(id) {
      var td, _t45;
  ...
  var handleLogin = function () {
    var _ref115 = _asyncToGenerator(_regenerator().m(function _callee39(email, pass) {
      var _d$session, _d$user, d, tok, uid, _t47;
  ...
  var handleRegister = function () {
    var _ref116 = _asyncToGenerator(_regenerator().m(function _callee40(email, pass, name) {
      var _d$session2, _d$user2, d, tok, uid, _d2$session, d2, tok2, _t48, _t49, _t50;
  ...
  var addFine = function () {
    var _ref117 = _asyncToGenerator(_regenerator().m(function _callee41(d) {
  ...
  var togglePaid = function () {
    var _ref118 = _asyncToGenerator(_regenerator().m(function _callee42(id) {
      var f, _t51;
  ...
  var delFine = function () {
    var _ref119 = _asyncToGenerator(_regenerator().m(function _callee43(id) {
      var _t52;
  ...
  var editFine = function () {
    var _ref120 = _asyncToGenerator(_regenerator().m(function _callee44(id, data) {
      var _t53;
  ...
  var addExpense = function () {
    var _ref121 = _asyncToGenerator(_regenerator().m(function _callee45(d) {
      var _yield$api$post3, _yield$api$post4, e, _t54;
  ...
  var logSession = function () {
    var _ref122 = _asyncToGenerator(_regenerator().m(function _callee46(recurring, date, currentPresences) {
      var alreadyLogged, res, newT, presArr, _t55;
      return _regenerator().w(function (_context46) {
        while (1) switch (_context46.p = _context46.n) {
          ...
          case 3:
            ...
            presArr = Object.entries(currentPresences || {}).filter(function (_ref123) {
            ...
            _context46.n = 4;
            return Promise.all(presArr.map(function (_ref125) {
  ...
  var addTraining = function () {
    var _ref127 = _asyncToGenerator(_regenerator().m(function _callee47(d) {
  ...
  var delTraining = function () {
    var _ref128 = _asyncToGenerator(_regenerator().m(function _callee48(id) {
      var _t56;
  ...
  var editTraining = function () {
    var _ref129 = _asyncToGenerator(_regenerator().m(function _callee49(id, d) {
      var patch, res, t;
  ...
  var setPresence = function () {
    var _ref130 = _asyncToGenerator(_regenerator().m(function _callee50(tid, mid, status) {
      var _t57;
  ...
  var addMember = function () {
    var _ref131 = _asyncToGenerator(_regenerator().m(function _callee51(d) {
      var r, m, _t58;
  ...
  var leaveTeam = function () {
    var _ref132 = _asyncToGenerator(_regenerator().m(function _callee52(tid) {
      var m, remaining, _t59;
      return _regenerator().w(function (_context52) {
        while (1) switch (_context52.p = _context52.n) {
          case 0:
            m = members.find(function (m) {
              return m.teamId === tid && m.userId === myUserId;
            });
            if (m) {
              _context52.n = 1;
              break;
          ...
          case 1:
            _context52.p = 1;
            _context52.n = 2;
            return api.del("team_members?id=eq.".concat(m.id), token);
          case 2:
            setTeams(function (p) {
              return p.filter(function (t) {
                return t.id !== tid;
          ...
          case 4:
            ...
            _t59 = _context52.v;
            console.error(_t59);
            alert("Erro ao sair da equipa");
          case 5:
            return _context52.a(2);
        }
      }, _callee52, null, [[1, 4]]);
    }));
    return function leaveTeam(_x37) {
      return _ref132.apply(this, arguments);
    };
  }();
  var toggleRole = function () {
    var _ref133 = _asyncToGenerator(_regenerator().m(function _callee53(id, newRole) {
      var m, nr, _t60;
      return _regenerator().w(function (_context53) {
        while (1) switch (_context53.p = _context53.n) {
          ...
          case 1:
            nr = newRole || (m.role === 'admin' ? 'player' : 'admin');
            _context53.p = 2;
            _context53.n = 3;
    ...
    return function toggleRole(_x38, _x39) {
      return _ref133.apply(this, arguments);
    };
  }();
  var removeMember = function () {
    var _ref134 = _asyncToGenerator(_regenerator().m(function _callee54(id) {
      var _t61;
    ...
    return function removeMember(_x40) {
      return _ref134.apply(this, arguments);
    };
  }();
  var editMember = function () {
    var _ref135 = _asyncToGenerator(_regenerator().m(function _callee55(id, data) {
      var m, r, e, _t62;
        ...
        while (1) switch (_context55.p = _context55.n) {
          case 0:
            ...
            return fetch("".concat(SB_URL, "/rest/v1/rpc/update_team_member_profile"), {
              ...
              body: JSON.stringify({
                p_member_id: m === null || m === void 0 ? void 0 : m.userId,
          ...
          case 4:
            ...
            _t62 = _context55.v;
            console.error(_t62);
            alert('Erro: ' + _t62.message);
          case 5:
            return _context55.a(2);
        }
      }, _callee55, null, [[0, 4]]);
    }));
    return function editMember(_x41, _x42) {
  ...
  var createTeam = function () {
    var _ref136 = _asyncToGenerator(_regenerator().m(function _callee56(d) {
      var tid, invCode, sr, se, tr, newTeam, _t63;
      return _regenerator().w(function (_context56) {
        while (1) switch (_context56.p = _context56.n) {
          ...
          case 8:
            _context56.p = 8;
            _t63 = _context56.v;
            setTeamError(_t63.message || JSON.stringify(_t63));
          case 9:
            return _context56.a(2);
        }
      }, _callee56, null, [[1, 8]]);
    }));
    return function createTeam(_x43) {
      return _ref136.apply(this, arguments);
    };
  }();
  var deleteTeam = function () {
    var _ref137 = _asyncToGenerator(_regenerator().m(function _callee57(teamId) {
      var remaining, _t64;
      return _regenerator().w(function (_context57) {
        while (1) switch (_context57.p = _context57.n) {
          ...
          case 5:
            _context57.p = 5;
            _t64 = _context57.v;
            console.error('deleteTeam error:', _t64);
          case 6:
            return _context57.a(2);
        }
      }, _callee57, null, [[0, 5]]);
    }));
    return function deleteTeam(_x44) {
      return _ref137.apply(this, arguments);
    };
  }();
  var joinTeam = function () {
    var _ref138 = _asyncToGenerator(_regenerator().m(function _callee58(t) {
      var _e$message, _t65;
      return _regenerator().w(function (_context58) {
        while (1) switch (_context58.p = _context58.n) {
          ...
          case 2:
            _context58.p = 2;
            _t65 = _context58.v;
            if ((_e$message = _t65.message) !== null && _e$message !== void 0 && _e$message.includes('duplicate key')) {
              _context58.n = 3;
              break;
            }
            alert("Erro ao entrar na equipa: ".concat(_t65.message || "tenta novamente"));
    ...
    return function joinTeam(_x45) {
      return _ref138.apply(this, arguments);
    };
  }();
  var findTeamByCode = function () {
    var _ref139 = _asyncToGenerator(_regenerator().m(function _callee59(code) {
      var r, d, t, _t66;
      return _regenerator().w(function (_context59) {
        while (1) switch (_context59.p = _context59.n) {
          ...
          case 2:
            ...
            return _context59.a(2, t !== null && t !== void 0 && t.id ? aTeam(_objectSpread(_objectSpread({}, t), {}, {
              invite_code: t.invite_code
            })) : null);
          case 3:
            _context59.p = 3;
            _t66 = _context59.v;
            return _context59.a(2, null);
        }
      }, _callee59, null, [[0, 3]]);
    }));
    return function findTeamByCode(_x46) {
  ...
  var subscribeToPush = function () {
    var _ref140 = _asyncToGenerator(_regenerator().m(function _callee60(tok, uid) {
      var _subJson$keys, _subJson$keys2, reg, existing, _sub, subJson, _t67, _t68;
      return _regenerator().w(function (_context60) {
        while (1) switch (_context60.p = _context60.n) {
          ...
          case 7:
            _context60.p = 7;
            _t68 = _context60.v;
            console.warn("Push subscribe failed:", _t68.message);
          case 8:
            return _context60.a(2);
        }
      }, _callee60, null, [[1, 7]]);
    }));
    return function subscribeToPush(_x47, _x48) {
  ...
  useEffect(function () {
    ...
    if ("Notification" in window && Notification.permission === "default") {
      setTimeout(_asyncToGenerator(_regenerator().m(function _callee61() {
        var perm;
  ...
  var sendPushToTeam = function () {
    var _ref142 = _asyncToGenerator(_regenerator().m(function _callee62(teamId, members, title, body) {
      var userIds, _t69;
      return _regenerator().w(function (_context62) {
        while (1) switch (_context62.p = _context62.n) {
          ...
          case 3:
            _context62.p = 3;
            _t69 = _context62.v;
            console.warn("Push send failed:", _t69.message);
          case 4:
            return _context62.a(2);
        }
      }, _callee62, null, [[1, 3]]);
    }));
    return function sendPushToTeam(_x49, _x50, _x51, _x52) {
      return _ref142.apply(this, arguments);
    };
  }();
  var addFineWithToast = function () {
    var _ref143 = _asyncToGenerator(_regenerator().m(function _callee63(d) {
      var m;
    ...
    return function addFineWithToast(_x53) {
  ...
  if (!team) return React.createElement("div", {
    ...
    onJoin: (function () {
      var _ref144 = _asyncToGenerator(_regenerator().m(function _callee64(t) {
  ...
  return React.createElement("div", {
    ...
    user: _objectSpread(_objectSpread({}, profile || {}), {}, {
      position: ((_members$find2 = members.find(function (m) {
        return m.userId === myUserId && m.teamId === teamId;
      })) === null || _members$find2 === void 0 ? void 0 : _members$find2.position) || (profile === null || profile === void 0 ? void 0 : profile.position) || ''
    }),
    myUserId: myUserId,
    teams: teams,
    members: members,
    ...
    user: profile || {},
    onSave: (function () {
      var _ref145 = _asyncToGenerator(_regenerator().m(function _callee65(u) {
        var _members$find3;
        var _t70;
        return _regenerator().w(function (_context65) {
          while (1) switch (_context65.p = _context65.n) {
            ...
            case 3:
              _context65.n = 4;
              return editMember((_members$find3 = members.find(function (m) {
                return m.userId === myUserId && m.teamId === teamId;
              })) === null || _members$find3 === void 0 ? void 0 : _members$find3.id, u);
            case 4:
    ...
    onFindByCode: findTeamByCode,
    onJoin: (function () {
      var _ref146 = _asyncToGenerator(_regenerator().m(function _callee66(t) {
